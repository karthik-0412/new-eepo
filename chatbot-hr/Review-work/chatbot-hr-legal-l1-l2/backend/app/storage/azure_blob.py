...
class AzureBlobStorage:
    ...
    def upload_file(self, file_content: bytes, filename: str, content_type: Optional[str] = None) -> dict:
        """
    ...
    def list_files(self, max_results: Optional[int] = None) -> List[dict]:
        ...
        for blob in container_client.list_blobs():
            ...
            blob_url = f"{self.service_client.get_blob_client(self.container_name, blob.name).url}?{sas_token}"
